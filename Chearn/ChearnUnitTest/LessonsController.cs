    ...
    public class LessonsController : Controller
    {
        ...
        public JsonResult GetLessonsByName(int courseID, string name)
        {
            ...
            if (course != null && course.Instructor.CUser.AspID == User.Identity.GetUserId())
            {
                ...
                && l.Title.Contains(name)).Select(x => new { x.ID, x.Title}), JsonRequestBehavior.AllowGet);
            }
            else
            {
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult Create([Bind(Include = "ID,Title,MaterialA,MaterialB,CourseID")] Lesson lesson)
        {   
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,MaterialA,MaterialB,CourseID")] Lesson lesson)
        {
            if (ModelState.IsValid)
            {
